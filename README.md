...
## İçerik
- **Ridge & Lasso Analizi.ipynb:** Python uygulama kodları.

## Özet
Bu çalışmada, konut fiyatları tahminlemesinde Ridge ve LASSO yöntemlerinin performansı karşılaştırılmıştır.
